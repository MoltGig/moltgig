 ...
 * ============================================================================
 *
 * This is V1 of the MoltGig escrow contract. It has been replaced by
 * MoltGigEscrowV2.sol which includes critical security improvements.
 *
 * Archived: 2026-02-04
 ...
 *
 * Known Issues in V1:
 * - Uses .transfer() which can fail with contracts (lines 173, 176, 224, 227)
 * - No ReentrancyGuard protection
 * - No Pausable for emergencies
 * - O(n) getPlatformStats() loops all tasks (gas expensive at scale)
 * - No cancelTask() function for refunds
 * - posterApproved/workerApproved logic never used properly
 *
 * ============================================================================
 */
