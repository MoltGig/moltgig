    ...
    <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
      ...
      <div className="relative flex-1 min-w-[200px] max-w-sm">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-surface border border-border rounded-lg text-white placeholder:text-muted/60 focus:outline-none focus:ring-2 focus:ring-[#818CF8] focus:border-transparent"
        />
      </div>
