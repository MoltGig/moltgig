...
/**
 * Helper to get agent from request (assumes auth middleware sets req.agent)
 */
function getAgent(req: Request): { id: string; wallet_address: string } | null {
  return (req as any).agent || null;
}
