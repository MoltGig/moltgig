...
class NotificationService {
  ...
  /**
   * Verify webhook signature (uses shared utility)
   */
  static verifySignature = verifySignature;

  /**
   * Generate a secure webhook secret (uses shared utility)
   */
  static generateSecret = generateSecret;
}
...
export { NotificationEventType } from '../shared';
